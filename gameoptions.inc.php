 ...
 * gameoptions.inc.php
 *
 * Biomos game options description
 * 
 ...
 *        with the same ID (see "initGameStateLabels" in biomos.game.php)
 *
...
$game_options = array(
    ...
    */
    ...
    100 => array(
        ...
        'values' => array(
            1 => array( 'name' => totranslate('Family'), 'tmdisplay' => totranslate('Family mode'), 'description' => totranslate('Play with the simple board without additional actions') ),
            2 => array( 'name' => totranslate('Advanced'), 'tmdisplay' => totranslate('Advanced mode'), 'description' => totranslate('Play with asymmetrical boards and additional actions'), 'nobeginner' => true ),
        ),
        'default' => 1
    ),
...
$game_preferences = array(
    100 => array(
            'name' => totranslate('Scrolling Biomes'),
